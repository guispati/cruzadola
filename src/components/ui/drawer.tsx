...
const drawerContentVariants = cva("z-50 flex h-auto flex-col border bg-gray-100", {
	variants: {
		direction: {
			...
			left: "left-0 rounded-[10px] inset-y-0 w-full h-full",
		},
	},
	defaultVariants: {
		direction: "right",
...
const DrawerHeader = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
	<div className={cn("grid gap-1.5 p-4 text-center w-full", className)} {...props} />
);
